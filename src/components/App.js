    ...
    <>
      <div className="w-full p-5">
        <div className="container flex flex-col gap-y-8 md:gap-y-10 mx-auto px-5 py-5 sm:py-12 md:py-10 lg:py-15 xl:py-20 text-gray-200 bg-gray-800 rounded-2xl">
          ...
          <div data-test="box-marker" className='sm:w-1/4 px-5 border border-solid border-gray-300 rounded-lg shadow' onClick={() => {
            setMarked(!marked)
          }}>
            <div id="value" data-test="marked-value">{marked ? 'Check' : 'UnChecked'}</div>
          </div>
        </div>
      </div>
    </>
